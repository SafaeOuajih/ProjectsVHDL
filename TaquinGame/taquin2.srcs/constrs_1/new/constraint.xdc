...
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { bouton_1 }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { bouton_2 }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { bouton_3 }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
...
#set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports led1s]
#set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports led2s]
#set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports led3s]
#set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports led4s]
#set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { data_en }]; #IO_L7P_T1_D09_14 Sch=led[4]
...
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { HEX00 }]; #IO_L24N_T3_A00_D16_14 Sch=ca
#set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { HEX01 }]; #IO_25_14 Sch=cb
#set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { HEX02 }]; #IO_25_15 Sch=cc
#set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { HEX03 }]; #IO_L17P_T2_A26_15 Sch=cd
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { HEX04 }]; #IO_L13P_T2_MRCC_14 Sch=ce
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { HEX05}]; #IO_L19P_T3_A10_D26_14 Sch=cf
#set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { HEX06 }]; #IO_L4P_T0_D04_14 Sch=cg
...
#set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports bouton_1]
#set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports bouton_4]
#set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports bouton_2]
#set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports bouton_5]
#set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports bouton_3]
...
#set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { MICRO_LR_SEL }]; #IO_0_35 Sch=m_lrsel
...
#set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { rx }]; #IO_L12N_T1_MRCC_35 Sch=uart_cts
