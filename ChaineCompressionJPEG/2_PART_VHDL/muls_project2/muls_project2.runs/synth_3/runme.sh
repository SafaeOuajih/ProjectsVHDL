...
HD_PWD='/net/e/souajih/Documents/blegal/EN325/2_PART_VHDL/muls_project2/muls_project2.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log MULS_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MULS_WRAPPER.tcl
