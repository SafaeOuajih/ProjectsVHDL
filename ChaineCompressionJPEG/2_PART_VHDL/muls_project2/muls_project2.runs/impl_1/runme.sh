...
HD_PWD='/net/e/souajih/Documents/blegal/EN325/2_PART_VHDL/muls_project2/muls_project2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MULS_WRAPPER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MULS_WRAPPER.tcl -notrace
